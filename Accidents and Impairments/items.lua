return {
    ...
    PlaceObj('ModItemTraitPreset', {
        ...
        description = T(630404482146, --[[ModItemTraitPreset IntellectuallyImpaired description]] "Can't work as a Scientist, Officer or Medic."),
    ...
    PlaceObj('ModItemTraitPreset', {
        category = "other",
        apply_func = function (colonist, trait)
            if table.find({"engineer", "geologist", "botanist"}, colonist.specialist) then
                colonist:SetSpecialization("none")
            end
        end,
        daily_update_func = function (colonist, trait)
        ...
        description = T(740962527296, --[[ModItemTraitPreset PhysicallyImpaired description]] "Can't work as an Engineer, Geologist or Botanist. Cannot work on Ranches."),
        display_icon = "",
